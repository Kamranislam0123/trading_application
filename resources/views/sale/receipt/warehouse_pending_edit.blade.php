...
@section('content')
    <form method="POST" enctype="multipart/form-data" action="{{ route('sale_receipt_warehouse_pending.edit', ['order'=>$order->id]) }}">
        @csrf
                    ...
                    <div class="box-body">
                        <div class="row">
                            ...
                            @if (\Illuminate\Support\Facades\Auth::user()->company_branch_id == 0)
                                <div class="col-md-4">
                                    <div class="form-group {{ $errors->has('') ? 'has-error' :'' }}" id="form-group-company">
                                        <label>Company *</label>
