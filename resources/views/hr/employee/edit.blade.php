                        ...
                        <div class="form-group {{ $errors->has('mobile_no') ? 'has-error' :'' }}">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" placeholder="Enter Mobile No. (11 digits)"
                                       name="mobile_no" value="{{ empty(old('mobile_no')) ? ($errors->has('mobile_no') ? '' : $employee->mobile_no) : old('mobile_no') }}" pattern="[0-9]{11}" maxlength="11">
                        ...
                        <div class="form-group {{ $errors->has('present_address') ? 'has-error' :'' }}">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" placeholder="Enter Present Address"
                                       name="present_address" rows="3">{{ empty(old('present_address')) ? ($errors->has('present_address') ? '' : $employee->present_address) : old('present_address') }}</textarea>
                        ...
                        <div class="form-group {{ $errors->has('permanent_address') ? 'has-error' :'' }}">
                            ...
                            <div class="col-sm-10">
                                <textarea class="form-control" placeholder="Enter Permanent Address"
                                       name="permanent_address" rows="3">{{ empty(old('permanent_address')) ? ($errors->has('permanent_address') ? '' : $employee->permanent_address) : old('permanent_address') }}</textarea>
