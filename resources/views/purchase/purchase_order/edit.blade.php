    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form method="POST" action="{{ route('purchase_order.edit', ['order'=>$order->id]) }}">
                    @csrf
                            ...
                            <div class="col-md-4">
                                <div class="form-group {{ $errors->has('product_type') ? 'has-error' :'' }}">
                                    ...
                                    <select class="form-control select2" style="width: 100%;" name="product_type">
                                        ...
                                        <option value="1" {{ old('product_type', $order->product_type) == 1 ? 'selected' : '' }}>China Product</option>
                                        <option value="2" {{ old('product_type', $order->product_type) == 2 ? 'selected' : '' }}>Bangla Product</option>
                                    </select>
                            ...
                            <table class="table table-bordered table-striped">
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <th colspan="" class="text-right">Sub Total</th>
